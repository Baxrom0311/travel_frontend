                    ...
                    <Link href={`/tours/${tour.slug}`} className="block">
                      <div className="relative h-52 overflow-hidden">
                        ...
                        <div className="absolute top-3 left-3 glass-strong px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1">
                          <Star size={10} className="fill-amber-500 text-amber-500" strokeWidth={2.5} /> {tour.rating}
                        </div>
                      ...
                      <div className="p-5">
                        ...
                        <div className="flex flex-wrap gap-3 text-xs text-muted-foreground mb-4">
                          <span className="flex items-center gap-1"><Clock size={12} strokeWidth={2.5} />{tour.duration} {tour.duration_type_label}</span>
                          <span className="flex items-center gap-1"><Users size={12} strokeWidth={2.5} />Max {tour.max_people}</span>
                        </div>
